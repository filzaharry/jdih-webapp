            ...
            >
              ...
              <div className="flex flex-row">
                <div className="flex flex-row sm:mr-2 lg:mr-10">
                  ...
                  <p className="text-colorPrimary sm:text-sm lg:text-lg">Selasa, 18 Juli 2023</p>
                </div>
                <div className="flex flex-row">
                  <AiFillInfoCircle className="sm:text-sm lg:text-xl sm:mr-1 lg:mr-2 mt-0.5 text-[#FF4E4E]" />
                  <p className="text-colorPrimary sm:text-sm lg:text-lg">Umum</p>
                </div>
              </div>
              <div className="py-4 lg:mt-4">
                <p className="sm:text-sm lg:text-lg text-justify">
                  ...
                  sebutan Kota Benteng. Saat ini sisa bangunan "Bentengan"
                  tersebut berada di beberapa titik di bawah permukaan air
                  Sungai Cisadane yang semakin melebar. 1654 M: "Tanggeran"
                  Bangunan PenandaNama "Tangerang" berasal dari sebutan
                  masyarakat sekitar terhadap bangunan tugu dengan tinggi
                  kira-kira 2,5 meter yang didirikan Pangeran Soegiri, putra
                  Sultan Ageng Tirtayasa dari Kesultanan Banten, bersama-sama
                  dengan masyarakat sekitar pada tanggal 5 Sapar tahun Wawu (
                  1654 Masehi ) yang terletak kira-kira 500 meter di tepi barat
                  bantaran sungai Cisadane tepatnya di Gardu Gede yang kini
                  dikenal dengan nama Kampung Gerendeng. Fungsi tugu tersebut
                  adalah sebagai pembatas atau penanda wilayah kekuasaan
                  kesultanan Banten di sebelah barat Sungai Cisadane dengan
                  wilayah yang dikuasi VOC di sebelah timur. Atas dasar
                  fungsinya tersebut, masyarakat menyebut tugu dan daerah itu
                  dengan sebutan "Tetengger" atau "Tanggeran" yang berarti
                  "penanda". Pasca 17 April 1684: Dari "Tanggeran" menjadi
                  "Tangerang" Pasca penandatanganan perjanjian antara VOC dengan
                  Kesultanan Banten yang diwakili oleh Sultan Haji atau Sultan
                  Abunnashri Abdulkahar putra Sultan Ageng Tirtayasa pewaris
                  Kesultanan Banten tanggal 17 April 1684, Belanda sepenuhnya
                  menguasai wilayah "Tanggeran". Dalam penguasaannya, tentara
                  Belanda juga merekrut warga pribumi di antaranya dari Madura
                  dan Makasar yang di antaranya ditempatkan di sekitar wilayah
                  benteng. Tentara VOC yang berasal dari Makasar tidak mengenal
                  huruf mati, dan terbiasa menyebut "Tangeran" dengan
                  "Tangerang". Kesalahan ejaan dan dialek inilah yang diwariskan
                  dari generasi ke generasi bahkan hingga saat ini. Pasca Tahun
                  1981 - 1993: Wilayah yang Berkembang Pesat Seiring berjalannya
                  ...
                  1981 tentang Pembentukan Kota Administratif Tangerang.Adapun
                  Walikota Administratif Tangerang yang telah menjabat mulai
                  terbentuk Kota Administratif adalah :1. Periode 1982-1986 :
                  Bapak KARSO PERMANA, BA2. Periode 1986-1990 : Bapak Drs. H.
                  YITNO3. Periode 1990-1993 : Bapak Drs. H. DJAKARIA MACHMUD 1
                  Juni 1987 sampai dengan 28 Februari 1993: Dari Kabupaten ke
                  KotamadyaDalam perjalanan kurun waktu 12 Tahun Kabupaten
                  Tangerang kembali menunjukan perkembangan dan pertumbuhan di
                  segala bidang. Dengan lama proses 5 tahun 8 bulan 27 hari
                  yaitu sejak tanggal 1 Juni 1987 sampai dengan 28 Februari 1993
                  dan secara resmi Kotamadya Daerah Tingkat II Tangerang menjadi
                  Daerah Otonom Ke-25 di Jawa Barat dan Ke-312 se Indonesia.
                  ...
                  1993-Sekarang: Para PemimpinSatu tahun kemudian, berdasarkan
